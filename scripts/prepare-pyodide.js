...
async function downloadPackages() {
	...
	const pyodideVersion = (packageJson.dependencies?.pyodide || packageJson.devDependencies?.pyodide).replace('^', '');
...
async function copyPyodide() {
	console.log('Skipping Pyodide copy - files already in static/pyodide from download');
	// Pyodide files are already in static/pyodide from downloadPackages()
